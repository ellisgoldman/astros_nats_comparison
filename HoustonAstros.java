...
/**
 * Write a description of class HoustonAstros here.
 * 
 * @author Ellis Goldman 
 * @version 5-19-2020
 */
public class HoustonAstros extends Team
{
    /**
     * Constructor for objects of class HoustonAstros
     */
    public HoustonAstros() throws IOException
    {
        super("HoustonAstros.txt");
    }
    ...
    {
        System.out.println("\n\n");
        System.out.printf("%-8s %-3s %-2s %-3s %-3s %-3s %-3s %-3s %-3s %-3s %-3s %-4s %-4s \n", 
            "Player", "POS", "GP", " AB", "  R", "  H", " 2B", " 3B"," HR", "RBI", " SO", " AVG", "   SLG");
    }
    ...
    {
        System.out.println("\n\nEnter option: ");
        System.out.println("\t 1 - Print all Astros data \n" +
    ...
    public void printBattingAverageMax()
    {
        System.out.println(findMaxBattingAveragePlayer() + 
            " has the highest AVG on the Astros with a batting average of " + 
    ...
    public void printSluggingPercentageMax()
    {
        System.out.println(findMaxSluggingPercentagePlayer() + 
            " has the highest SLG on the Astros with a slugging percentage of " + 
    ...
    {
        System.out.printf("Astros overall team batting average is %5.2f \n" , 
    ...
    {
        System.out.printf("Astros overall team slugging percentage is %5.2f \n" , 
    ...
    {
        HoustonAstros bsbl = new HoustonAstros();
        boolean done = false;
        while(! done)
        {
            done = bsbl.interactWithUser();
        }
    }
}
